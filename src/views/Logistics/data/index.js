export const trucking = [
  {
    ...
    subtitle:
      'DataLoci is built to make your life easier. Variables, build tooling, documentation, and reusable components.',
  },
  {
    icon: 'fab fa-sketch',
...
export const integrations = [
  ...
  },
  {
    ...
    name: 'Mailchimp',
    title:
      'Communicate important messages to your users through DataLoci using Mailchimp as the delivery service.',
  },
  {
...
export const news = [
  {
    cover: {
      src: '/images/photos/logistics/news1.jpg',
      srcSet: '/images/photos/logistics/news1@2x.jpg 2x',
    },
    tag: 'delivery',
  ...
  {
    cover: {
      src: '/images/photos/logistics/news2.jpg',
      srcSet: '/images/photos/logistics/news2@2x.jpg 2x',
    },
    tag: 'Main stream',
    title: 'Optimize the schedules of thousands of trains in minutes.',
    date: '12 June, 2020',
  ...
  {
    cover: {
      src: '/images/photos/logistics/news3.jpg',
      srcSet: '/images/photos/logistics/news3@2x.jpg 2x',
    },
    tag: 'Trucks',
    title: 'Optimize the schedules of thousands of trains in minutes.',
    date: '12 June, 2020',
