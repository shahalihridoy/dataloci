        ...
        >
          <Grid item>
            <SectionHeader
              ...
              title={
                <>
                  <span>
                    ...
                    <br />
                    <span className="text-highlighted">ever created</span>
                    <br />
                    <span className="text-highlighted">for&nbsp;</span>
                  </span>
                  <TypedText
                    component="span"
                    variant="h4"
              ...
              subtitle="Using DataLoci to build your site means never worrying about designing another page or cross browser compatibility. Our ever-growing library of components and pre-designed layouts will make your life easier."
              align="left"
              disableGutter
            />
